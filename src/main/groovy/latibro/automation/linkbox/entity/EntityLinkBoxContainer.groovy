...
@CompileStatic
class EntityLinkBoxContainer extends Container {

    EntityLinkBoxContainer(InventoryPlayer playerInv, final EntityLinkBoxTileEntity entityLinkBox) {
        IItemHandler inventory = entityLinkBox.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.NORTH)

        addSlotToContainer(new SlotItemHandler(inventory, 0, 80, 35) {
            @Override
            void onSlotChanged() {
                entityLinkBox.markDirty()
            }
        })
