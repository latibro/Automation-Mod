...
abstract class PeripheralTileEntity extends TileEntity implements IPeripheral, ManagedPeripheral, Environment {
    ...
    void ocInit() {
        ocNode = Network.newNode(this, Visibility.Network).withComponent(getComponentName(), Visibility.Network).create()
    }
